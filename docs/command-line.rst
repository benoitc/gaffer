...
:doc:`gaffer` is a manager for Procfile-based applications similar to
...
gafferd configuration file or simply to a JSON file that you could
send to gafferd using the :doc:`HTTP api <http>`.
